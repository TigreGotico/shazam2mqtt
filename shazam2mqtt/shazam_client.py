"""Thin async wrapper around xazam for byte-array identification."""

import asyncio
import logging

from xazam import ShazamClient, ShazamTransport, RecognitionResult

logger = logging.getLogger(__name__)


class ShazamBridge:
    """Wraps xazam so the state machine never holds a transport session open."""
